...
const MainPage = () => {
  return (
    <div className='flex justify-between ml-[240px] mr-[30px] mt-[50px] w-[920px] '>
            <div className='flex flex-col justify-center'>
                <div className='text-[#FF3147] text-xl'>
                    <h2>Award Wining </h2>
                </div>
            ...
            <div className='m-10'> 
                <img src={mainHero} className='w-[587px]  h-[537px]' alt="Not Found" />
            </div>
    </div>
  )
}
